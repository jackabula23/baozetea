...
<section class="container mx-auto py-20 px-10 bg-gray-100 max-w-4xl">
    <div class="flex flex-col flex-wrap -mx-2 ">
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <a class="py-1 px-2 bg-teal-400 text-white"
                            href="{{url('/increase-one-item')}}/{{$book['item']['id']}}">+</a>|
                        <a class="py-1 px-2 bg-red-300 text-white"
                            href="{{url('/decrease-one-item')}}/{{$book['item']['id']}}">-</a>|
                        <a class="py-1 px-2 bg-red-700 text-white uppercase"
                            href="{{url('/remove-item')}}/{{$book['item']['id']}}">Remove</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="flex justify-end mt-4">
            <a href="{{url('/clear-cart')}}" class="mr-4 px-6 py-3 border border bg-white text-orange-600 border-orange-600">Clear
                Cart</a>
            <a href="{{url('/order/new')}}" class="text-white px-6 py-3 bg-orange-600">Buy Now</a>
        </div>
    </div>
</section>
@endsection
